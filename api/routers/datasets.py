...
def list_datasets(
    ...
    category_id: Annotated[int | None, Query(description="Filter datasets by category ID")] = None,
    include_layers: Annotated[bool, Query(description="Include related layers in response")] = False,
