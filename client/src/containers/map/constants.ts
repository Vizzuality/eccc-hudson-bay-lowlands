...
export const BASEMAPS = {
  ...
  [BasemapId.SATELLITE]: {
    ...
    image: `https://api.mapbox.com/styles/v1/ecc-design/cmk2eevpe00k801s91cva9417/static/7.1924,4.7851,3.85,0,0/200x200@2x?access_token=${env.NEXT_PUBLIC_MAPBOX_API_TOKEN}&attribution=false&logo=false`,
  },
} as const;
