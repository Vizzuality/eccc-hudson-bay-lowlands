...
| Client i18n | next-intl | 4.7.0 | Internationalization |
...
| DB driver | psycopg | 3.0+ | PostgreSQL adapter |
...
| SQLAlchemy 2.0+ with psycopg v3 | Modern async-ready ORM with latest PostgreSQL driver | - |
